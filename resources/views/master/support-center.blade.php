...
$(document).ready(function() {
    ...
    $('#buttonsModal .modal-body .buttons').append(buttons);

    $('#tableButtonsBtn').click(function() { $('#buttonsModal').modal('show'); });

    $('#infoBtn').click(function() { $('#infoModal').modal('show'); });

    $('#newDataBtn').click(function() { $('#newDataModal').modal('show'); });

    $('#cancelDataBtn').click(function() { $('#newDataForm')[0].reset(); });
    ...
    $('#tbody').on('click', '.deleteDataBtn', function() {
        $('#displayDeleteLabel').html($(this).attr('deleteLabel'));
        $('#deleteRow').val($(this).attr('deleteRow'));
        $('#deleteId').val($(this).attr('deleteId'));
        $('#deleteDataModal').modal('show');
    });

    $('#keepDataBtn').click(function(e) {             
    ...
    $('#submitDeleteDataBtn').click(function(e) {
        e.preventDefault();
        var self = $(this);
    ...
    $('#tbody').on('click', '.editDataBtn', function() {
     ...
     //$('#cancelEditDataBtn').click(function() { $('#editDataForm')[0].reset(); });
