...
<body>
    ...
    <!-- Pre-loader - ORIGINAL CENTERED VERSION (UNCHANGED) -->
    <div id="preloader">
        <div id="status">
    ...
    <div class="wrapper">
            ...
            <div class="topbar container-fluid">
                <div class="d-flex align-items-center gap-lg-2 gap-1">
                    ...
                    <div class="logo-topbar">
                        <a href="{{ route('master.dashboard') }}" class="logo-light">
                            <span class="logo-lg"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
                            <span class="logo-sm"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
                        </a>
                        <a href="{{ route('master.dashboard') }}" class="logo-dark">
                            <span class="logo-lg"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
                            <span class="logo-sm"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
                        </a>
                    </div>
                    ...
                    <li class="dropdown me-md-2">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button">
                            ...
                            <!--<span class="d-lg-flex flex-column gap-1 d-none">
                                ...
                                <h6 class="my-0 fw-normal">Netamind</h6>
                            </span>-->
                        </a>
        ...
        <div class="leftside-menu">
            ...
            <!-- Brand Logo -->
            <a href="{{ route('master.dashboard') }}" class="logo logo-light" style="text-align:left;padding-left:20px;">
                <span class="logo-lg"><img src="{{ asset('dashboard/images/mlogo.png') }}" alt="" style="height:35px"></span>
                <span class="logo-sm"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
            </a>
            <a href="{{ route('master.dashboard') }}" class="logo logo-dark" style="text-align:left;">
                <span class="logo-lg"><img src="{{ asset('dashboard/images/mlogo.png') }}" alt="" style="height:35px"></span>
                <span class="logo-sm"><img src="{{ asset('dashboard/images/icon.png') }}" alt=""></span>
            </a>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                <div class="leftbar-user p-3 text-white">
                    <a href="{{route('master.profile')}}"  class="d-flex align-items-center text-reset">
                ...
                <li class="side-nav-item">
                    <a data-bs-toggle="collapse" href="#sidebarTenants" aria-expanded="false" class="side-nav-link">
                    ...
                    <div class="collapse" id="sidebarTenants">
                        <ul class="side-nav-second-level">
                            ...
                            <li><a href="{{ route('master.tenants.by_currency') }}">Billing by Currency</a></li>
                    ...
                    <li class="side-nav-item">
                        <a href="{{ route('master.events') }}" class="side-nav-link">
                    ...
                    <!-- ADMISTRATION -->
                    <li class="side-nav-title mt-2">ADMISTRATION</li>

                    <li class="side-nav-item">
                        <a href="{{ route('master.company.info') }}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{ route('master.employees') }}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarSecurity">
                            <ul class="side-nav-second-level">
                                <li><a href="{{ route('master.roles') }}">Roles</a></li>
        ...
        @yield('content', View::make('master.default'))
