...
<div class="card">
  ...
  <div class="card-header d-flex justify-content-between align-items-center">
    <h4 class="header-title mb-0">
      <a href="{{ route('retail.operations.fullstocktaking') }}" class="btn btn-light text-primary fs-16 mx-1" title="Back to Stocktaking" style="margin-right:8px;">
        <i class="ri-arrow-left-line"></i>
      </a>
      <form method="GET" action="{{ route('retail.operations.fullstocktaking.history') }}" id="histBranchForm" style="margin:0;display:inline;">
...
$(document).ready(function () {
    ...
    var table = $('#historyTable').DataTable({
        ...
        buttons: [
            { extend: 'excelHtml5', title: 'Stocktaking History', exportOptions: { columns: ':visible:not(:last-child)' } },
            { extend: 'csvHtml5',   title: 'Stocktaking History', exportOptions: { columns: ':visible:not(:last-child)' } },
            { extend: 'pdfHtml5',   title: 'Stocktaking History', exportOptions: { columns: ':visible:not(:last-child)' },
    ...
    $(document).on('click', '.quickStatsBtn', function (e) {
        ...
        // Wire "View Details" button inside modal — derive from the row's own View link
