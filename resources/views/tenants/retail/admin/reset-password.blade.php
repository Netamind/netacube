                        ...
                        <div class="card-body">
                            <form action="#" method="post" id="dataForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="password" name="password" id="password" placeholder="Enter your new password" autocomplete="off" required>
                                </div>
                                <div class="mb-3">
                                    <label for="password_confirmation" class="form-label">Confirm New Password</label>
                                    <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm your new password" autocomplete="off" required>
                                </div>
                              

                                 <div class="mt-2 mb-3">
                                        <a href="#" class="text-muted fs-15" id="cancelDataBtn2">Cancel</a>
                                        <a href="{{route('master.login.page')}}" class="text-muted float-end fs-15">Login <i class="ri-arrow-right-line"></i></a>
                                    </div>


                                <div class="text-center">
                                    <button class="btn btn-primary form-control" type="submit" id="submitDataBtn"> <i class="ri-lock-fill"></i> Reset Password </button>
                                </div>
    ...
    <script src="{{ asset('library/cropper/cropper.js') }}"></script>
     ...
     <script>
        ...
        $('#submitDataBtn').click(function(e) {
            ...
            $.ajax({
                type: "post",
                url:  "{{ route('master.submit.password.reset') }}",
                data: $(form).serialize(),
                timeout: 60000,
                beforeSend: function() {
                     $('#progressBar').show();
