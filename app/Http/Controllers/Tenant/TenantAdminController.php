...
class TenantAdminController extends Controller
{
    ...
    {
        return view('tenants.admin.employee-details');
    }
    ...
    {
        return view('tenants.admin.subscription-plans');
    }
    ...
    {
        return view('tenants.admin.invoice-templates');
    }
    ...
    {
        return view('tenants.admin.point-of-sales');
    }
