...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center" style="gap:4px;">
      ...
      <a href="{{ route('retail.orders.rare') }}" class="btn btn-light text-primary fs-16 mx-1" title="New order">
    ...
    <ul class="nav nav-pills px-2 pt-1">
      <li class="nav-item">
        <a class="nav-link" href="{{ route('retail.orders.rare') }}"><i class="ri-quill-pen-line"></i> Rare</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="{{ route('retail.orders.rare.history') }}"><i class="ri-history-line"></i> History</a>
      </li>
    </ul>
  </div>
...
$('#elSaveBtn').on('click', function () {
    ...
    $.post(ROUTES.lineUpdate, payload).done(function () {
        ...
        // are shown/editable here, so patch just those cells and re-sort
        // via the DataTable API instead of reloading the page.
        if (dt) {
