...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <ul class="nav nav-pills px-2 pt-1">
      <li class="nav-item">
        <a class="nav-link active" href="{{ route('retail.orders.emergency') }}"><i class="ri-alarm-warning-line"></i> Emergency</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('retail.orders.emergency.history') }}"><i class="ri-history-line"></i> History</a>
      </li>
    </ul>
  </div>
...
<div class="modal fade" id="downloadModal" tabindex="-1">
  <div class="modal-dialog modal-xl">
    <div class="modal-content" style="border:none;border-radius:10px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.18);">
      <div class="modal-header mh-blue">
        <h5 class="modal-title mh-title"><i class="ri-download-2-line"></i> Emergency Orders</h5>
        <button type="button" class="btn-close mh-close" data-bs-dismiss="modal"></button>
      </div>
