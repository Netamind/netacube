        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <!-- ==================== PROCUREMENT ==================== -->
                    {{--
                        "Products" is the master product catalogue. Sits here because
                        procurement teams define what can be purchased and stocked.
                    --}}
                    ...
                    <!-- ==================== DISTRIBUTION ==================== -->
                    {{--
                        Covers the flow of goods from central/warehouse outward to branches.

                        "Allocation"      — push product quantities to one branch or all branches at once
                        "Despatch Notes"  — download/print internal delivery notes per distribution run
                        "Dispatch Log"    — full history of all past distributions
                        "Pricing"         — track and manage product price changes over time
                    --}}
                    <li class="side-nav-title mt-2">Distribution</li>
                    ...
                    <!-- ==================== CLIENTS ==================== -->
                    {{--
                        "Customers" — client directory and contact profiles
                        "Accounts"  — per-client credit/debit ledger and statement of account
                    --}}
                    <li class="side-nav-title mt-2">Clients</li>
                    ...
                    <!-- ==================== REPORTS ==================== -->
                    {{--
                        "Debtors"  — replaces the vague "Receivables"; standard accounting term
                                     for amounts owed to the business by customers
                        "Payables" — unchanged; already a well-understood accounting term
                    --}}
