...
<head>
    <meta charset="utf-8" />
    <title>Create your Netacube account</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Register your business on Netacube and get full access to sales, inventory, staff and payroll tools. 14-day free trial, no card required.">

    {{-- CSRF meta tag — read/updated by the background refresh script below --}}
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* Standardize card width across screen sizes — a little wider than the
           sign-in card since this form carries more fields. */
        .auth-card-wrap {
            width: 100%;
            max-width: 620px;
            margin-left: auto;
        ...
        .reg-form-heading { text-align: center; margin-bottom: 8px; }
        .reg-form-heading .eyebrow-sm { font-size: 0.74rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: #d7deff; margin-bottom: 8px; display: block; }
        .reg-form-heading h1 { font-size: 1.7rem; font-weight: 800; color: #fff; letter-spacing: -0.01em; margin-bottom: 10px; }
        .reg-form-heading p { font-size: 0.92rem; color: rgba(255,255,255,0.75); margin: 0 auto; max-width: 460px; line-height: 1.65; }

        .reg-steps { display: flex; align-items: center; margin: 26px auto 0; max-width: 280px; }
        .reg-step { display: flex; flex-direction: column; align-items: center; position: relative; flex: 1; }
        .reg-step-dot {
            width: 32px; height: 32px; border-radius: 50%; border: 2px solid rgba(255,255,255,0.3); background: rgba(255,255,255,0.08);
            display: flex; align-items: center; justify-content: center; font-size: 0.78rem; font-weight: 700;
            color: rgba(255,255,255,0.75); z-index: 2; position: relative; transition: .2s;
        }
        .reg-step.active .reg-step-dot { background: #fff; border-color: #fff; color: var(--brand); box-shadow: 0 4px 14px rgba(0,0,0,0.25); }
        .reg-step.done .reg-step-dot { background: #4ade80; border-color: #4ade80; color: #0e2a13; }
        .reg-step-label { font-size: 0.7rem; font-weight: 600; color: rgba(255,255,255,0.6); margin-top: 6px; text-align: center; white-space: nowrap; }
        .reg-step.active .reg-step-label { color: #fff; }
        .reg-step.done .reg-step-label { color: #4ade80; }
        .reg-step-line { position: absolute; top: 16px; left: calc(50% + 16px); right: calc(-50% + 16px); height: 2px; background: rgba(255,255,255,0.25); z-index: 1; }
        .reg-step.done .reg-step-line { background: #4ade80; }

        .reg-card { background: #fff; border-radius: var(--radius-lg); padding: 38px; box-shadow: 0 24px 60px rgba(0,0,0,.3); margin-top: 26px; }
        ...
        .terms-notice { font-size: 0.76rem; color: rgba(255,255,255,0.7); text-align: center; margin-top: 18px; }
        .terms-notice a { color: #fff; font-weight: 600; }
        .reg-footer-links { text-align: center; margin-top: 14px; font-size: 0.85rem; color: rgba(255,255,255,0.7); }
        .reg-footer-links a { color: #fff; font-weight: 700; }
...
<body class="position-relative">
    ...
    <!-- ══ Same background treatment as the sign-in page ══ -->
    <div class="position-fixed start-0 end-0 top-0 bottom-0 w-100 h-100" style="z-index:-1;">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1920 1024">
            <g mask="url(&quot;#SvgjsMaskGS&quot;)" fill="none">
                <rect width="1920" height="1024" x="0" y="0" fill="url(#SvgjsLinearGradientGS)"></rect>
            ...
            <defs>
                ...
                <linearGradient x1="11.67%" y1="-21.87%" x2="88.33%" y2="121.88%" gradientUnits="userSpaceOnUse" id="SvgjsLinearGradientGS">
            ...
            <div class="col-12">
                <div class="auth-card-wrap">
                    ...
                    <div class="brand-mark">
                        <a href="/"><img src="{{ asset('website/images/wlogo.png') }}" alt="Netacube"></a>
                    </div>

                    <div class="reg-form-heading">
                        <span class="eyebrow-sm">Create your account</span>
                        <h1>Set up your business on Netacube</h1>
                        <p>One account gives every branch, till and team member access to the same live data — tell us a little about your business and you'll be ready to start working in minutes.</p>
                    </div>

                    <div class="reg-steps" id="stepsNav" style="margin-left:auto;margin-right:auto;">
                    ...
                    <div class="reg-card">
                        ...
                        <div id="step1">
                            <form id="registrationForm" autocomplete="off" novalidate>
                                ...
                                <!-- Honeypot fields: invisible to real users, bots tend to fill every input they find.
                                     Names are deliberately non-standard and use autocomplete="new-password"
                                     because that's the one value browsers reliably refuse to autofill. -->
                        ...
                        <div id="step2" style="display:none;">
                            ...
                            <div class="human-check">
                                ...
                                <input type="text" inputmode="numeric" id="hcAnswer" placeholder="?" maxlength="3" autocomplete="off">
    ...
    $(function() {
        ...
        // Keep the CSRF token fresh in the background so this page can stay
        // open indefinitely without the form ever going stale. Same
        // non-fatal pattern used on the sign-in page: failures are silently
        // retried next cycle and never shown to the user.
