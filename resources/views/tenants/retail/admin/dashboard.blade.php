    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="{{ route('tenant.super.admin.dashboard') }}" class="logo logo-light" style="text-align:left;padding-left:20px;">
                <span class="logo-lg"><img src="{{ asset('tenants/admin/images/retail.png') }}" alt="" style="height:35px"></span>
                <span class="logo-sm"><img src="{{ asset('tenants/admin/images/icon2.png') }}" alt=""></span>
            </a>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <!-- RETAIL OPERATIONS -->
                    <li class="side-nav-title mt-2">Retail Operations</li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarPurchases">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="#">Suppliers / Vendors</a>
                                </li>
                                <li>
                                    <a href="#">Purchase Orders</a>
                                </li>
                                <li>
                                    <a href="#">Goods Receipt / GRN</a>
                                </li>
                                <li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarCustomers">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="#">Credit / Wallet Management</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarReports">
                            <ul class="side-nav-second-level">
                                ...
                                <li>
                                    <a href="#">Employee / Cashier Performance</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarSettings">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="#">Branches / Stores</a>
                                </li>
                                <li>
                                    <a href="#">Tax Rates & Rules</a>
                                </li>
                                <li>
                                    <a href="#">Payment Methods</a>
                                </li>
                                <li>
                                    <a href="#">Pricing & Markup Rules</a>
                                </li>
                                <li>
                                    <a href="#">Barcode & Label Settings</a>
                                </li>
                                <li>
