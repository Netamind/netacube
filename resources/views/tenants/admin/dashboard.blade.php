    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <a href="{{ route('tenant.admin.dashboard') }}" class="logo logo-light" style="text-align:left;padding-left:20px;">
                <span class="logo-lg"><img src="{{ asset('tenants/admin/images/icon1.png') }}" alt="" style="height:35px"></span>
                <span class="logo-sm"><img src="{{ asset('tenants/admin/images/icon2.png') }}" alt=""></span>
            </a>
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                <div class="leftbar-user p-3 text-white">
                    <a href="{{ route('tenant.profile') }}" class="d-flex align-items-center text-reset">
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="{{ route('tenant.employees') }}" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="{{ route('tenant.roles') }}" class="side-nav-link">
